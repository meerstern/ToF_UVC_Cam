...
#define INTERRUPT_PIN                         1     /**< interupt to digital 7 */
...
#define TRIGGER_INTERRUPT_PIN                 1     /**< the arduino uno can only handle interrupts on pin 2, 3 so re-route your pin 7 also to pin2 if you want to use interrupt */
